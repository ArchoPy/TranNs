def func(num, old_osn, new_osn): # num - число в начальной системе счисления old_osn, переводим в new_osn
    alf = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ' # алфавит, вмещающий в себя 36 символов (область работы функции - до 36 системы счисления)
    ...
    while number % new_osn != 0: # стандартный алгоритм перевода, пока остаток от деления не нулевой...
        ...
        final_num += alf[ost] # пополняем каркас числа литералами из alf. Поскольку в alf все литералы упорядочены и начинаются с нуля, то остаток будет эквивалентен символу из alf под таким же индексом
