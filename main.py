def func(num, old_osn, new_osn): # num - число в начальной системе счисления old_osn, переводим в new_osn
    ...
    while number % new_osn != 0: # стандартный алгоритм перевода, пока остаток от деления не нулевой...
        ...
        final_num += alf[ost] # пополняем каркас числа литералами из alf. Поскольку в alf все литералы упорядочены и начинаются с нуля, то остаток будет эквивалентен числу из alf под таким же индексом
